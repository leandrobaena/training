...
public class GetClassMethod {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Class of str1 object instance is " + str1ClassName);
        ...
        System.out.println("Class of int1 object instance is " + int1ClassName);


        // Create Date object instance
        Date date1 = new Date();
        ...
        System.out.println("Class of date1 object instance is " + date1ClassName);
    }
